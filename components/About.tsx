...
export default function About() {
  return (
    <section id="about" className="bg-[#FAF8F5] py-16 sm:py-20 lg:py-28 border-b border-[#eae6db]">
      <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 lg:items-center">
            ...
            <div className="relative group w-full max-w-[320px] sm:max-w-[380px] aspect-[4/5] rounded-3xl overflow-hidden border-4 border-white bg-brand-dark shadow-md transition-all duration-500 hover:shadow-xl hover:scale-[1.01]">
              ...
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 flex items-center justify-between rounded-xl bg-black/60 backdrop-blur-md px-3 sm:px-4 py-2.5 sm:py-3 border border-white/10">
                <span className="text-[9px] sm:text-[10px] font-bold tracking-widest text-brand-gold uppercase">
                  Director, Digital Growth & Strategy
                </span>
                <a
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-zinc-900 leading-tight mb-7 sm:mb-8">
              Strategy Grounded in Real Execution
            </h2>

            <div className="space-y-5 sm:space-y-6 text-zinc-600 leading-7 sm:leading-8 text-sm sm:text-base font-medium">
              <p>
                ...
                Solo360 was created to bring those pieces together, helping businesses find clarity, create alignment, and drive measurable longterm growth.
              </p>
            </div>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-8 sm:mt-10 inline-flex items-center justify-center gap-2 rounded-full bg-brand-gold px-7 sm:px-8 py-3.5 sm:py-4 text-sm font-bold text-zinc-950 shadow-sm transition-all hover:bg-brand-gold-dark hover:scale-[1.02] group min-h-[48px]"
            >
              Book Discovery Call
            </Link>
          </div>
